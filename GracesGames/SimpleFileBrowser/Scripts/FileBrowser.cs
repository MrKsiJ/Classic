	...
	public class FileBrowser : MonoBehaviour {
		...
		public void SetupFileBrowser(ViewMode newViewMode, string startPath = "") {
			...
			if (uiCanvas != null) {
                ...
                fileBrowserUi.transform.localScale = new Vector3(0.6f, 0.6f, 1);
			}
		...
		public void CloseFileBrowser() {
            addWorkItem.isSearchFileInAddWorkshopItem = false;
			OnFileBrowserClose();
			Destroy();
		}
